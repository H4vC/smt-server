...
└── SOLVE / MINIMIZE / MAXIMIZE
    -> RacingBackend(default budget: 30s)
       ...
       ├── BinbitBackend
       ├── QfbvsmtrsBackend
       └── BitwuzlaBackend   (optional, enabled with --features bitwuzla)
```
